...
class RecordPointer
{
  public:
    ...
    RecordPointer(u16 bufferID, u16 posIndex) : bufferID{bufferID}, posIndex{posIndex}
    {
    }
};
...
class NonLeafPage : public IndexPage
{
  public:
    ...
    NonLeafPage(u16 pageID, const vector<DBColumn> &keyColumns, const PageHeader &header, Buffer &buffer);
...
class LeafPage : public IndexPage
{
  public:
    ...
    LeafPage(u16 pageID, const vector<DBColumn> &keyColumns, const PageHeader &header, Buffer &buffer);
...
namespace bplustree
{
bool Search(BufferManager &bufferManager, Buffer &buffer, shared_ptr<IndexPage> root, const Index &index);
